...
%El proyecto pretende cumplir varios objetivos. El primero es estudiar los fundamentos de las Tensor Networks, sus topologías principales y su relación con modelos de \textit{machine learning}. El segundo, implementar modelos entrenables usando PyTorch y TensorKrowch, manteniendo una separación clara entre la representación de la imagen y la capa tensorial. El tercero es entrenar y evaluar los modelos sobre conjuntos de datos de clasificación de imágenes, con métricas y diagnósticos que permitan interpretar no solo la precisión final, sino también el comportamiento del entrenamiento.
