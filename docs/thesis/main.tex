...
\input{chapters/1_preliminares}

\input{chapters/2_indices}
...
\input{chapters/5_Marco_Teorico}

\input{chapters/6_metodologia}

\input{chapters/8_Resultados}

\input{chapters/9_discusion}

\input{chapters/10_conclusiones}

\input{chapters/12_referencias}
